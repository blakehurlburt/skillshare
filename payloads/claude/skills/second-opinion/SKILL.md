...
If you haven't already this session: set `SKILL_NAME=second-opinion` and read `~/.claude/skills/_shared/preamble.md`, then execute its bash block and follow its directives. Skip if already done.
