...
If you haven't already this session: set `SKILL_NAME=review` and read `~/.codex/skills/_shared/preamble.md`, then execute its bash block and follow its directives. Skip if already done.
